...
export const projects: Project[] = [
  {
    ...
    category: 'deployment',
    canvasMode: 'terminal',
    description: 'The operations interface I built over my Hetzner infrastructure: manage deployments after GitHub Actions ships, inspect services, and work with agents through the same control surface.',
    stack: ['TypeScript', 'Docker', 'Caddy', 'Hetzner', 'React'],
    architecture: 'An authenticated Next.js control plane reaches the host locally or over SSH, connecting Docker, Caddy/Nginx, metrics, topology, and deployment workflows. Its AI operations assistant can inspect the system and propose actions, with consequential changes gated for approval.',
    highlights: [
      'Dashboard, live topology, container controls, logs, and a browser terminal for infrastructure you own.',
      'A shared authenticated interface for the operator and their agents, with an integrated AI operations assistant.',
      'Post-release visibility across workloads, routes, deployments, alerts, and host health.',
    ],
  ...
  },
  {
    ...
    category: 'health',
    canvasMode: 'agents',
    description: 'A deployed Twi-first health research preview connecting voice interaction to corpus engineering, Qwen LoRA adaptation, human review, and guarded semantic evaluation.',
    stack: ['Next.js', 'TypeScript', 'Python', 'Modal GPU', 'PostgreSQL'],
    architecture: 'A Next.js PWA connects ASR/TTS on Modal to guarded meaning extraction and response generation. A separate research workbench manages candidate provenance, human review, silver-corpus experiments, and model promotion evidence.',
    highlights: [
      '12,223 review candidates and a separate 7,814-row silver research corpus.',
      'Qwen LoRA v3 trained on Modal A100 and published to Hugging Face; not promoted after 7/11 product-fixture passes.',
      'Docker, Caddy, Prisma migrations, secret sync, CI/CD, and production smoke checks.',
    ],
