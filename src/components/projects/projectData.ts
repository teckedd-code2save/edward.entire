...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: 'health',
    canvasMode: 'agents',
    description: 'A production Twi-first health and commerce companion with safety-aware guidance, streamed voice interaction, and a measurable path from speech research to deployment.',
    stack: ['Next.js', 'TypeScript', 'Python', 'Modal GPU', 'PostgreSQL'],
    architecture: 'A Next.js PWA connects health RAG and commerce workflows to ASR/TTS services on Modal, with evaluation gates, model promotion checks, audit trails, and self-hosted production infrastructure.',
    highlights: [
      'Twi understanding, ASR, TTS, and live-pipeline evaluation suites.',
      'Safety-aware maternal guidance, retrieval, intent routing, and fallback contracts.',
